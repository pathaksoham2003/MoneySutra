  ...
  return (
    <div className="w-full flex justify-center h-[64px] ">
      ...
      <div className="w-full max-w-[1204px] flex justify-between">
        ...
        <div onClick={()=>window.open("https://drive.google.com/file/d/1WA2YziiRcTgQ8R0_J5m-9AdAeadxVbfw/view?usp=sharing","__blank")} className="relative bg-accent md:max-w-[300px] rounded-l-full md:rounded-none pl-4 flex justify-center items-center">
